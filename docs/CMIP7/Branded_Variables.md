...
- **branded_variable** is composed of the **root name** followed by a **branding suffix** (e.g., `tas_tavg-h2m-hxy-u`), as [described above](Branded_Variables.md). It is a mandatory [global attribute][global-attributes-latest].
